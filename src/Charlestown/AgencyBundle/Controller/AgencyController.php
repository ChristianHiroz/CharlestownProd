...
use Charlestown\AgencyBundle\Entity\Agency;
use Charlestown\AgencyBundle\Form\AgencyType;
...
class AgencyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CharlestownAgencyBundle:Agency')->findAll();
     ...
     * @Method("POST")
     * @Template("CharlestownAgencyBundle:Agency:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CharlestownAgencyBundle:Agency')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CharlestownAgencyBundle:Agency:edit.html.twig")
     */
